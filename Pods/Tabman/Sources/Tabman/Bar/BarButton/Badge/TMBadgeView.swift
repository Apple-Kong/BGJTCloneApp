...
open class TMBadgeView: UIView {
    ...
    private struct Defaults {
        static let contentInset = UIEdgeInsets(top: 2.0, left: 0.0, bottom: 2.0, right: 4.0)
        static let font = UIFont.systemFont(ofSize: 10, weight: .bold)
    ...
    open override var tintColor: UIColor! {
        didSet {
            contentView.backgroundColor = UIColor(red: 0.847, green: 0.049, blue: 0.098, alpha: 1)
        }
    }
